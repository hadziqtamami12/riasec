...
@section('page_title')
   {{"Daftar Kelebihan Tipe Kepribadian"}}
@endsection
         ...
         <div class="widget-header">
            ...
            <form class="form-inline mt-4 mb-1">
               <h4 class="col-10"><b>{{$pageName}}</b></h4>
                  <div class="col-auto">
                     <a href="{{ route('kelebihantipe.create') }}" class="btn btn-primary mb-2"><i data-feather="plus"></i>{{$pageActive}}</a>
                  </div>
            </form>
         </div> {{-- widget-header --}}
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <form action="{{ route('kelebihantipe.destroy', $tipe->id) }}" method="post" class="dropdown custom-dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                              ...
                              <a class="dropdown-item btn btn-sm text-warning" style="padding-left: 22px;" href="{{ route('kelebihantipe.edit', $tipe->id) }}">Edit</a>
                              @csrf
                              @method('DELETE')
