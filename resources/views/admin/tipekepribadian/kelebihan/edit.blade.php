      ...
      <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
         ...
         <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
               ...
               <form method="POST" action="{{ route('kelebihantipe.update', $kelebihantipe->id) }}" class="section contact">
                  @method('PUT')
                  @csrf
                           ...
                           <div class="row">
                              <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                       ...
                                       <select class="form-control" name="tipekep_id">
                                          <option value="{{ $kelebihantipe->tipekep_id }}" selected>{{ $kelebihantipe->tipekepribadian->namatipe }}</option>
                              ...
                              <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                       ...
                                       <input type="teks" class="form-control @error('kelebihan_tipe') is-invalid @enderror" name="kelebihan_tipe" value="{{old('kelebihan_tipe', $kelebihantipe->kelebihan_tipe )}}">
