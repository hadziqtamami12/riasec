   ...
   <div class="col-12">
         ...
         <div class="widget-header">
            ...
            <form class="form-inline mt-4 mb-1">
               <h4 class="col-10"><b>{{$pageName}}</b></h4>
                  <div class="col-auto">
                     <a href="{{ route('partnertipe.create') }}" class="btn btn-primary mb-2"><i data-feather="plus"></i>{{$pageActive}}</a>
                  </div>
            </form>
         </div> {{-- widget-header --}}
                     ...
                     <td class="text-center">
                        <div class="dropdown custom-dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="dropdownMenuLink12">
                              ...
                              <a class="dropdown-item btn btn-sm text-warning" href="{{ route('partnertipe.edit', $tipe->id) }}">Edit</a>
      ...
      <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
         <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="{{ route('partnertipe.destroy', $tipe->id) }}" method="post">
               @csrf
               @method('DELETE')
