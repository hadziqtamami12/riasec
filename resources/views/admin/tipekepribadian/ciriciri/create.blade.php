...
@section('page_title')
   {{"Create Ciri-ciri Tipe Kepribadian"}}
@endsection
      ...
      <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
         ...
         <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
               ...
               <form method="POST" action="{{ route('ciritipe.store') }}" class="section contact">
                  @csrf
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                       ...
                                       <input type="teks" class="form-control @error('ciri_kepribadian') is-invalid @enderror" name="ciri_kepribadian" value="{{old('ciri_kepribadian')}}">
