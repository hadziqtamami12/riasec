...
@section('page_title')
   {{"Saran Profesi Tipe Kepribadian"}}
@endsection
      ...
      <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
         ...
         <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
               ...
               <form method="POST" action="{{ route('profesitipe.store') }}" class="section contact">
                  @csrf
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                       ...
                                       <input type="teks" class="form-control @error('profesi_tipe') is-invalid @enderror" name="profesi_tipe" value="{{old('profesi_tipe')}}">
                  ...
                  <div class="account-settings-footer">
                     <div class="as-footer-container">
                        <a href="{{ route('profesitipe.index') }}" class="btn btn-dark" >Kembali</a>
