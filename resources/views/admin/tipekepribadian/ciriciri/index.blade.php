               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <form action="{{ route('ciritipe.destroy', $ciri->id) }}" method="post" class="dropdown custom-dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                              ...
                              <a class="dropdown-item btn btn-sm text-warning" style="padding-left: 22px;" href="{{ route('ciritipe.edit', $ciri->id) }}">Edit</a>
                              @csrf
                              @method('DELETE')
