      ...
      <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
         ...
         <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
               ...
               <form method="POST" action="{{ route('kekurangantipe.store') }}" class="section contact">
                  @csrf
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                       ...
                                       <input type="teks" class="form-control @error('kekurangan_tipe') is-invalid @enderror" name="kekurangan_tipe" value="{{old('kekurangan_tipe')}}">
