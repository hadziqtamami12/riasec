   ...
   <div class="container">
         <div class="row">
            ...
            <div class="col-md-6 order-sm-2 footer-social-icons"><span>Follow us:</span>
               <a href="https://www.google.com/intl/id/gmail/about/"><i class="far fa-envelope"></i></a>
               <a href="https://twitter.com/JPCPoliwangi"><i class="fab fa-twitter"></i></a>
               <a href="https://www.instagram.com/poliwangi_jinggo/?hl=en"><i class="fab fa-instagram"></i></a> 
               <a href="https://www.youtube.com/channel/UCACpvcuNCWbZxrL_5PBbFhw"><i class="fab fa-youtube"></i></a>
            </div>
            <!-- /SOCIAL ICONS -->
...
<div class="scroll-up">
   <ul>
      <li><a class="smooth-scroll" href="#header"><i class="fas fa-angle-up"></i></a>
      </li>
   </ul>
</div> {{-- /SCROLL-UP --}}